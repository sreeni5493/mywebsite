  ...
  const data = [
    {
      ...
      desc: "Build end to end data science pipelines for autonomous driving: traffic lights.",
      img: "/assets/bosch.png",
      website: "https://www.bosch-softwaretechnologies.com/en/index.html",
    },
    {
      id: "2",
      icon: "./assets/work.png",
    ...
    },
    {
      ...
      desc: "Bridging model based design with deep neural networks. Building computer vision algorithms along with simulation of rendered data using physically based rendering.",
      img: "/assets/fias.png",
